...
public final class SmokingBalance {
    ...
    public static final float DEPENDENCE_DECAY_PER_INTERVAL = 5.0F;
    ...
    public static final SmokingProfile MARLBORE_RED = cigarette(4.0F, minutes(5), 0, 0.05D, 0.6F, 0.25F);
    public static final SmokingProfile WINSTONE_BLUE = cigarette(4.5F, minutes(5), 0, 0.05D, 0.6F, 0.36F);
    public static final SmokingProfile CREPERFIELD = cigarette(3.0F, minutes(4), 0, 0.05D, 0.6F, 0.13F);
    public static final SmokingProfile CRAFTMEL = cigarette(2.5F, minutes(3), 0, 0.05D, 0.5F, 0.0F);
    public static final SmokingProfile CHUNKMAN = cigarette(4.0F, minutes(5), 0, 0.05D, 0.6F, 0.25F);
    public static final SmokingProfile KEND = cigarette(4.5F, minutes(5), 0, 0.05D, 0.6F, 0.22F);
    public static final SmokingProfile PIGLIAMENT = cigarette(3.5F, minutes(4), 0, 0.05D, 0.6F, 0.15F);
    public static final SmokingProfile ROTHMINES = cigarette(3.0F, minutes(4), 0, 0.05D, 0.6F, 0.0F);
    public static final SmokingProfile BEDROMORKANAL = cigarette(4.0F, minutes(5), 0, 0.05D, 0.6F, 0.20F);
    public static final SmokingProfile MINECRISTO_NO_1 = cigar(7.0F, minutes(7), 1, 0.10D, 1.0F, 0.0F);
    public static final SmokingProfile STONEO_Y_GLOWLIETA = cigar(6.0F, minutes(5), 0, 0.05D, 0.9F, 0.33F);

    public static final int MARLBORE_HASTE_TICKS = seconds(30);
    ...
    public static final int MICROBLAST_BUFF_TICKS = seconds(13);
    ...
    public static final int PIGLIAMENT_RESISTANCE_TICKS = seconds(35);
    public static final int PIGLIAMENT_RESISTANCE_AMPLIFIER = 0;
    public static final int ROTHMINES_HASTE_TICKS = seconds(75);
    public static final int ROTHMINES_HASTE_AMPLIFIER = 0;
    public static final float BEDROMORKANAL_HEALING = 2.0F;
    public static final int STONEO_NIGHT_VISION_TICKS = seconds(60);
    public static final int STONEO_GLOWING_TICKS = seconds(30);
    ...
    public static final int KEND_SLOW_FALLING_TICKS = seconds(40);
    public static final int KEND_JUMP_BOOST_TICKS = seconds(20);
    public static final int KEND_INVISIBILITY_TICKS = seconds(15);
    public static final int KEND_LEVITATION_TICKS = seconds(10);
    ...
    public static final double KEND_TELEPORT_RADIUS = 12.0D;
    ...
    public static final WithdrawalProfile NO_WITHDRAWAL =
            new WithdrawalProfile(0L, 0, 0, 0, 0.0F, 0.0D, 0.0D, 0.0F);
    public static final WithdrawalProfile MILD_WITHDRAWAL =
            new WithdrawalProfile(minutes(40), minutes(6), minutes(10), seconds(30),
                    0.05F, -0.03D, -0.05D, 0.05F);
    public static final WithdrawalProfile MODERATE_WITHDRAWAL =
            new WithdrawalProfile(minutes(30), minutes(4), minutes(7), seconds(40),
                    0.15F, -0.05D, -0.08D, 0.10F);
    public static final WithdrawalProfile HIGH_WITHDRAWAL =
            new WithdrawalProfile(minutes(20), minutes(3), minutes(5), seconds(50),
                    0.25F, -0.07D, -0.12D, 0.18F);
    public static final WithdrawalProfile SEVERE_WITHDRAWAL =
            new WithdrawalProfile(minutes(15), minutes(2), minutes(4), seconds(60),
